...
If you're reviewing Milestone 2 and prefer to start **immediately** — without first exploring the full documentation — this shortcut provides direct access to the core milestone logic through our mobile app, and local nodes.
<!--
...
This is the most complete and reliable way to test the M2 features:

- **Transaction with DOT, ETH, BTC, SOL** with Transaction validation (based on TAVP)
