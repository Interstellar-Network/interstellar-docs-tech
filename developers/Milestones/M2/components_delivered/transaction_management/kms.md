...
- Sign transaction payloads upon request from the Transaction Management Layer.
...
- No persistent key storage is used — keys exist for the duration of the worker runtime.
