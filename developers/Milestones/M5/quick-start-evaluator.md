...
If you're reviewing Milestone 5 and prefer to start **immediately** — without first exploring the full documentation — this shortcut provides direct access to the core milestone logic through our mobile app, and local nodes.
<!--
...
This is the most complete and reliable way to test the M5 walletConnect integration and its main features:

- Connect to Dapp

- Manage signing a transaction generated by a Dapp with or whithout VCA (Action Confirmation Screen)
