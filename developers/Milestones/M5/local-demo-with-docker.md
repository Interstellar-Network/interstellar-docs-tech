...
Milestone 5 delivers the WalletConnect integration whithin the Interstellar android wallet app tied to Interstelar infrastructure.
...
mkdir interstellar_m5_demo && cd interstellar_m4_demo
...
### 2.3 — Test connetivity and transaction signing (without approval) on Sepolia network
...
At the moment, the Ethereum flow exposed by the Reown lab is the one that allows testing signing transaction whithout the approval flow.
