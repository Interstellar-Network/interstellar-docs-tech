...
- The previous role of a “sidechains registry” is replaced by a **Signer Orchestrator** (inside workers) that will evolve to route across backends and, post-mainnet, across TEE families or MPC backends.
...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell>+ TDX/SEV/Arm CCA; optional TSS/MPC/NMC</TableCell>
