...
- Forward signing requests to the **KMS** (M2) or **Signer Orchestrator** (M3)  
...
4. TML forwards the request to the Signer Layer (KMS in M2; Orchestrator in M3)  
...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell>Policy-driven routing via Orchestrator</TableCell>
...
- Post-mainnet, it is expected to support multi-TEE and MPC routing for resilience and decentralization.
